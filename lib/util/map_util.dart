...
class MapUtil{
  ...
  final directions = APIDirections.GoogleMapsDirections(apiKey: 'AIzaSyDzo5gv3NE-ioSTCOxnQg2slOKt3PClEGs');
  final geolocation = APIGeolocation.GoogleMapsGeolocation(apiKey: 'AIzaSyDzo5gv3NE-ioSTCOxnQg2slOKt3PClEGs');
